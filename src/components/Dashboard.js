...
function Dashboard() {
    return (
        <Container maxWidth={false} className="dashboard-container" style={{ minHeight: '100vh', padding: '16px' }}>
            <Typography variant="h4" component="h1" className="font-bold mb-4 text-center creative-font">
                Admin Dashboard
            </Typography>
            <Grid container spacing={3} style={{ height: '100%', marginBottom: '20px' }}>
                {[
                    {
